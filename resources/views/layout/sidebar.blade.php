...
<nav class="sidebar">
    <div class="sidebar-header">
      <a href="#" class="sidebar-brand" style="font-size: 1.5em">
        DJPb <span>SITP-PSII</span>
      </a>
      <div class="sidebar-toggler not-active">
        <span></span>
        <span></span>
    ...
    <div class="sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item nav-category">web apps</li>
        <li class="nav-item {{ active_class(['apps/chat']) }}">
          <a href="https://span.kemenkeu.go.id/" class="nav-link" target="_blank">
            <i class="link-icon" data-feather="message-square"></i>
            <span class="link-title">SPAN</span>
          </a>
        </li>
        <li class="nav-item {{ active_class(['apps/calendar']) }}">
          <a href="https://sakti.kemenkeu.go.id/" class="nav-link" target="_blank">
            <i class="link-icon" data-feather="calendar"></i>
            <span class="link-title">SAKTI</span>
          </a>
        </li>
      </ul>
    </div>
